...
func (s *Store) CreateCalibration(name string, firstLobeDB, offsetTol, ratioMinDB, ratioMaxDB float64) (*model.CalibrationVersion, error) {
	...
	v := &model.CalibrationVersion{Version: version, Name: name, Active: false, FirstLobeDB: firstLobeDB, OffsetTolerance: offsetTol, RatioMinDB: ratioMinDB, RatioMaxDB: ratioMaxDB, CreatedAt: nowISO()}
	res, err := s.db.Exec(`
